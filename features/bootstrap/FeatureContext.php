...
class FeatureContext implements Context
{
	...
	/**
	 * @Then Auth request on :site with user :user and password :pass should contain following headers:
	 */
	public function authRequestOnShouldContainFollowingHeaders( $site, $user, $pass, TableNode $table )
	{
		$url = 'http://' . $site;
